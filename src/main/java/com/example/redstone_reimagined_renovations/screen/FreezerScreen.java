package com.example.redstone_reimagined_renovations.screen;
...
public class FreezerScreen extends HandledScreen<FreezerScreenHandler> {
    private static final Identifier TEXTURE = new Identifier(RedstoneReimaginedRenovations.MOD_ID, "textures/gui/freezer_gui.png");
